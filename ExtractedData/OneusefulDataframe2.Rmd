...
```{r Export csv file}
write.csv(Election1994, file = "Election1994.csv",row.names = FALSE)
write.csv(Election2010, file = "Election2010.csv",row.names = FALSE)
write.csv(Election2015, file = "Election2015.csv",row.names = FALSE)
```
