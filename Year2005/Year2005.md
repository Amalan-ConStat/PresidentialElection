...
Data extraction begins from page one of the document. There are two
...
Valid, Total Rejected, Total Polled and finally Total Registered votes.
The first column is similar to all pages which are followed by
electorate Votes obtained and their respective percentages, Finally ends
with Postal Votes and Total Votes.
...
The right count for Total Polled is 9826908 but it seems they have
misprinted it as 9826778.
...
The right count for Total rejected is 109869 but it seems they have
misprinted as 109739.
...
```
    ...
    ##                   ColNames    V1
    ## 1: Achala Ashoka Suraweera 31238
...
No issues here, except where in one situation the name has case
sensitive issues( de replaced as De).
...
```
    ...
    ##          ColNames   V1
    ## 1: Aruna de Soyza 7388
    ## 2: Aruna De Soyza  297
...
```
    ...
    ##                             ColNames   V1
    ## 1: Ajith Kumara Jayaweera Arachchige 5082
...
```
    ...
    ##                                ColNames   V1
    ## 1: Hewaheenipallage Shantha Dharmadwaja 1316
