...
So if we added those votes the final count will be as above.
Total No of Votes polled are 5186277.

```{r Total polled Gampaha}
...
```{r Tot Valid Trincomalee district}
...
not correct it should be 2289860(still mis calculated).
...
```{r Kurunegala district Validate 2}
...
count for Mr. Oswin Abhayagunasekara is 235701.
