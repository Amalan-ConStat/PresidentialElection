...
table representing  each disttrict. All tables follow the similar format. 
...
electors. After that we have 14 columns which are for candidates names, follwed by 
Valid Votes, Rejected Votes and finally Total polled.
...
Comparing final tally votes of Mrs. Chandrika Bandaranaike Kumarathunga or
the candidate from PA from the pdf file to the data extracted as below. 
